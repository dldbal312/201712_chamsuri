jQuery(document).ready(function(a) {
    ...
    function listGroup(){
        ...
        if($('.list-group-item').next('.list-depth2')){
            $('.list-depth2').prev().addClass('ico-depth');
        }; 
        if($('.ico-depth').hasClass('active')){
            $('.list-depth2').addClass('active');
        };   
    }
    listGroup();

    $('.topbar .h-banner .btn-close').on('click', function(){
    ...
    function e(b) {
        ...
        function(b, c, d, e) {
            ...
            a(b).on("click", function() {
                a(e).toggleClass("search-visible")
            }), a(c).on("click", function() {
                a(e).removeClass("search-visible")
            })
        }(".cats-toggle.hidden-md-max", ".close-btn", ".clear-search", ".site-search"), a(".lang-currency-switcher").on("click", function() {
